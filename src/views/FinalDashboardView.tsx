  ...
  return (
    <div className="w-full lg:w-7/12 flex flex-col justify-center my-auto">
      <motion.div 
        ...
        className="bg-[#160a0a]/90 border border-amber-500/40 rounded-2xl p-6 lg:p-8 shadow-2xl shadow-black backdrop-blur-xl flex flex-col space-y-8"
      >
        {/* Top Title Banner */}
        <div className="flex items-center space-x-4 pb-4 border-b border-[#381818]">
          ...
          <div>
            <span className="text-[11px] uppercase tracking-widest text-amber-500 font-semibold block">Booking Guide & Information</span>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-8 items-start">
          ...
          <div className="xl:col-span-5 bg-[#0e0505] p-6 rounded-2xl border border-[#381818] shadow-inner space-y-6">
            <div className="flex items-center space-x-2 pb-3 border-b border-[#281010]">
              <Ticket className="w-5 h-5 text-amber-500 shrink-0" />
              <h3 className="font-cinzel text-base font-bold text-amber-300 tracking-wider">BOOKING DETAILS</h3>
            </div>

            <div className="space-y-4 text-left text-xs">
              <div>
                <span className="text-[10px] uppercase text-gray-400 font-semibold block">Booking ID</span>
                <span className="font-mono text-sm font-bold text-amber-300 mt-0.5 block tracking-widest">{bookingState.bookingId}</span>
              </div>
              ...
              <div className="pt-2 border-t border-[#281010]">
          ...
          <div className="xl:col-span-7 bg-gradient-to-b from-[#1c0808] to-[#120404] p-6 rounded-2xl border border-amber-500/30 flex flex-col space-y-6 shadow-xl">
            <div className="pb-3 border-b border-amber-500/20 text-left">
              <span className="font-cinzel text-lg font-bold text-amber-300 tracking-wider">WHAT'S NEXT?</span>
              <p className="text-xs text-gray-400 mt-0.5">Please follow these instructions for a smooth venue experience</p>
            </div>

            <div className="space-y-5 text-left">
              {/* Step 1 */}
              <div className="flex items-start space-x-4 p-3.5 bg-black/40 rounded-xl border border-[#381818]">
                <div className="p-2.5 bg-amber-500/20 rounded-lg text-amber-400 border border-amber-500/30 shrink-0 mt-0.5">
                  <Mail className="w-5 h-5" />
                </div>
                <div>
                  <h4 className="text-xs font-bold uppercase tracking-wider text-amber-200">1. E-TICKET SENT</h4>
              ...
              <div className="flex items-start space-x-4 p-3.5 bg-black/40 rounded-xl border border-[#381818]">
                ...
                <div>
                  <h4 className="text-xs font-bold uppercase tracking-wider text-amber-200">2. SHOW YOUR TICKET</h4>
                  <p className="text-xs text-gray-300 mt-1 leading-snug">
              ...
              <div className="flex items-start space-x-4 p-3.5 bg-black/40 rounded-xl border border-[#381818]">
                ...
                <div>
                  <h4 className="text-xs font-bold uppercase tracking-wider text-amber-200">3. ARRIVE EARLY</h4>
                  <p className="text-xs text-gray-300 mt-1 leading-snug">
              ...
              <div className="flex items-start space-x-4 p-3.5 bg-black/40 rounded-xl border border-[#381818]">
                ...
                <div>
                  <h4 className="text-xs font-bold uppercase tracking-wider text-amber-200">4. ENJOY THE SHOW</h4>
                  <p className="text-xs text-gray-300 mt-1 leading-snug">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-6 border-t border-[#381818]">
          <button 
            ...
            className="w-full sm:w-auto px-8 py-4 rounded-xl border border-amber-500/50 text-amber-400 font-semibold hover:bg-amber-500/10 transition tracking-wider text-sm uppercase flex items-center justify-center space-x-2 shadow-sm"
          >
          ...
          <motion.button 
            ...
            whileTap={{ scale: 0.98 }}
            onClick={onGoHome}
            className="w-full sm:w-auto px-12 py-4 rounded-xl bg-gradient-to-r from-amber-400 via-amber-500 to-amber-600 text-black font-cinzel font-black text-base tracking-widest uppercase shadow-[0_0_30px_rgba(212,175,55,0.4)] hover:brightness-110 transition duration-300 flex items-center justify-center space-x-2 cursor-pointer"
          >
