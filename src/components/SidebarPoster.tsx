...
export const SidebarPoster: React.FC<SidebarPosterProps> = ({ bookingState, currentStep }) => {
  ...
  return (
    <div className="w-full lg:w-5/12 shrink-0 flex flex-col">
      <div className="sticky top-28 bg-[#0f121b]/95 rounded-2xl overflow-hidden border border-[#c5a059]/25 shadow-2xl group transition-all duration-500">
        {/* Glow effect */}
        <div className="absolute inset-0 bg-gradient-to-tr from-[#d4af37]/10 via-transparent to-[#c5a059]/5 opacity-40 group-hover:opacity-80 transition-opacity duration-500 pointer-events-none" />
        ...
        <div className="p-4 sm:p-6 relative z-10 -mt-16 sm:-mt-20 space-y-3 sm:space-y-4 text-center">
          <div className="inline-block px-3 py-1 bg-[#d4af37]/15 border border-[#d4af37]/30 rounded-full text-[#d4af37] text-xs uppercase tracking-widest font-semibold backdrop-blur-md mb-2">
            Immersive 3D Projection & Light Show
          </div>
          <h2 className="font-cinzel text-3xl lg:text-4xl font-extrabold text-[#e6ca65] tracking-wide drop-shadow-md">
            ASSAM
          </h2>
          <h3 className="font-cinzel text-xl lg:text-2xl font-bold text-[#d4af37] tracking-wider -mt-3">
            THE SAGA OF GLORY
          </h3>
          <p className="text-xs uppercase tracking-widest text-[#cbd5e1] font-medium pb-2 border-b border-[#232938]">
          ...
          {showSummaryBadges ? (
            <div className="grid grid-cols-2 gap-2 text-left pt-2">
              <div className="bg-black/50 p-2.5 rounded-lg border border-[#232938] flex items-center space-x-2">
                <Calendar className="w-4 h-4 text-[#d4af37] shrink-0" />
                <div className="min-w-0">
                  <p className="text-[10px] uppercase text-gray-400 font-semibold">Date</p>
                  <p className="text-xs text-[#e6ca65] font-medium truncate">{bookingState.selectedDate || '15 May 2025'}</p>
                </div>
              </div>
              ...
              <div className="bg-black/50 p-2.5 rounded-lg border border-[#232938] flex items-center space-x-2">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-xs text-[#e6ca65] font-medium truncate">{bookingState.selectedTime || '7:00 PM'}</p>
                </div>
              </div>
              ...
              <div className="bg-black/50 p-2.5 rounded-lg border border-[#232938] flex items-center space-x-2">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-xs text-[#e6ca65] font-medium truncate">Assam Assembly</p>
                </div>
              </div>
              ...
              <div className="bg-black/50 p-2.5 rounded-lg border border-[#232938] flex items-center space-x-2">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-xs text-[#e6ca65] font-medium truncate">30 Minutes</p>
                </div>
              </div>
            </div>
          ) : (
            <div className="flex items-center justify-around text-xs pt-2">
              <div className="flex flex-col items-center">
                ...
                <span className="font-mono font-bold text-[#d4af37] text-sm mt-0.5">126</span>
              </div>
              <div className="w-[1px] h-8 bg-[#232938]" />
              <div className="flex flex-col items-center">
                <span className="text-[10px] text-gray-400 uppercase font-semibold">Duration</span>
                <span className="font-mono font-bold text-[#d4af37] text-sm mt-0.5">30 Mins</span>
              </div>
              <div className="w-[1px] h-8 bg-[#232938]" />
              <div className="flex flex-col items-center">
                <span className="text-[10px] text-gray-400 uppercase font-semibold">Show Time</span>
                <span className="font-bold text-[#d4af37] text-xs mt-0.5">Every Evening</span>
              </div>
            </div>
          )}
        </div>
